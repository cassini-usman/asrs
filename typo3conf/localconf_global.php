 ...
 */
$TYPO3_CONF_VARS['EXT']['extList'] = 'extbase,css_styled_content,tsconfig_help,context_help,extra_page_cm_options,impexp,sys_note,tstemplate,tstemplate_ceditor,tstemplate_info,tstemplate_objbrowser,tstemplate_analyzer,func_wizards,wizard_crpages,wizard_sortpages,lowlevel,install,belog,beuser,aboutmodules,setup,taskcenter,info_pagetsconfig,viewpage,t3skin,t3editor,reports,static_info_tables,dam,rsaauth,saltedpasswords,realurl,go_tsconfig,go_pibase,go_pibase_local,static_info_tables_de,recycler,sys_action,version,dam_catedit,dam_index,dam_ttcontent,lfeditor,kickstarter,kb_tv_cont_slide,go_imageedit_be,info,perm,func,cshmanual,feedit,opendocs,scheduler,fluid,workspaces,go_stopcslide,go_language,tinymce_rte,go_kontakt,naw_securedl,dd_googlesitemap,queo_speedup,templavoila,go_backend_layout,go_tca';
$TYPO3_CONF_VARS['EXT']['extList_FE'] = 'extbase,css_styled_content,install,t3skin,static_info_tables,dam,rsaauth,saltedpasswords,realurl,go_tsconfig,go_pibase,go_pibase_local,static_info_tables_de,version,dam_catedit,dam_index,dam_ttcontent,lfeditor,kickstarter,kb_tv_cont_slide,go_imageedit_be,feedit,fluid,workspaces,go_stopcslide,go_language,tinymce_rte,go_kontakt,naw_securedl,dd_googlesitemap,queo_speedup,templavoila,go_backend_layout,go_tca';
