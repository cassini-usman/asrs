...
foreach (array('pages', 'pages_language_overlay') as $pages) {
	...
	t3lib_SpriteManager::addTcaTypeIcon($pages, '21', t3lib_extMgm::extRelPath('go_backend_layout') . 'res/images/doktype_icon_pagecontainer.png');
	// an der richtigen Stelle den neuen Seitentyp einfügen.
	$newPageType = array('LLL:EXT:go_backend_layout/locallang.xml:pages.doktypes.pagecontainer', '21', 'EXT:go_backend_layout/res/images/doktype_icon_pagecontainer.png');
