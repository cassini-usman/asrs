...
*  Copyright notice
*
*  (c) 2009 Alex Angold <alex@gosign.de>
*  All rights reserved
*
...
$LANG->includeLLFile('EXT:go_language/mod1/locallang.xml');
...
/**
 * Module 'WebLanguage' for the 'go_language' extension.
 *
 * @author	Alex Angold <alex@gosign.de>
 * @package	TYPO3
 * @subpackage	tx_gositelang
 */
class tx_golanguage_module1 extends t3lib_SCbase {
				var $pageinfo;
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/go_language/mod1/index.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/go_language/mod1/index.php']);
}
...
// Make instance:
$SOBE = t3lib_div::makeInstance('tx_golanguage_module1');
$SOBE->init();
