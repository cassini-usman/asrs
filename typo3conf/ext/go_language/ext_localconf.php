...
if (!defined ('PATH_GoLanguage')) {
	define('PATH_GoLanguage', t3lib_extMgm::extPath('go_language'));
}

require_once(PATH_GoLanguage . 'lib/user_languageRedirect.php');

t3lib_extMgm::addPItoST43($_EXTKEY, 'pi1/class.tx_golanguage_pi1.php', '_pi1', '', 1);
