 ...
 */
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['t3lib/class.t3lib_tceforms.php']['getMainFieldsClass'][''] = t3lib_extMgm::extPath('go_lll').'hooks/class.tx_golll_getMainFieldsClass.php:tx_golll_getMainFieldsClass';
